...
void VillageWindow::onEnterScene()
{
    ...
    if (!getState()->getFlag("was_in_village")) {
        ...
        m_dialogParts << "Вы входите в деревню и стоите на деревенской площади. "
                      ...
                      << "Староста Хельга, пожилая женщина, подходит к вам."
                      << "Староста Хельга: Спасибо, что пришли! Барон не даёт нам житья. Ночью из замка доносятся крики."
                        " Кузнец Альберт и знахарка Агата могут навести на мысль, как с ним справиться."
                        " Будьте осторожны!";
